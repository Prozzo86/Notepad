    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mprijava.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(), "Lozinka treba imati više od 7 znakova", Toast.LENGTH_SHORT).show();
                }
                else
                    {
                    firebaseAuth.createUserWithEmailAndPassword(mail, lozinka).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            {
                                Toast.makeText(getApplicationContext(), "Registracija uspješna!", Toast.LENGTH_SHORT).show();
                                sendEmailVerification();
                            }
                            else
                            {
                                Toast.makeText(getApplicationContext(), "Registracija neuspješna!", Toast.LENGTH_SHORT).show();
                    ...
                    private void sendEmailVerification()
                    {
                        ...
                        {
                            Toast.makeText(getApplicationContext(), "Neuspješno poslana verifikacija e-maila!", Toast.LENGTH_SHORT).show();
